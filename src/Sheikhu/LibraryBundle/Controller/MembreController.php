...
use Sheikhu\LibraryBundle\Form\MembreType;
...
class MembreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SheikhuLibraryBundle:Membre')->findAll();

        return $this->render('SheikhuLibraryBundle:Membre:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('SheikhuLibraryBundle:Membre:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SheikhuLibraryBundle:Membre')->find($id);
        ...
        return $this->render('SheikhuLibraryBundle:Membre:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('SheikhuLibraryBundle:Membre:edit.html.twig', array(
            'entity'      => $entity,
